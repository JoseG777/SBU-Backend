...
const default_prompt =
  "The following is the label of a medicinal bottle or product. Briefly answer the following questions:\n 1. What is this medication and what is it used for?\n 2. What should someone taking this medication be aware of?\n 3. How often should this person take this medication?";
async function basic_query(
  bottle_text,
  language = "english",
  prompt_engineering = default_prompt
) {
  const response = await openai.chat.completions.create({
    messages: [
      {
        role: "system",
        content: "You are a medical assistant who speaks" + language + ".",
      },
      {
        role: "user",
        content:
...
const constrained = (object_box, text_box, scale_w = 1, scale_h = 1) => {
  ...
  return t_x1 >= o_x1 && t_x2 <= o_x2 && t_y1 >= o_y1 && t_y2 <= o_y2;
};
...
router.post("/analyze-image", async (req, res) => {
  ...
  try {
    ...
    if (textOnBottle === "Too many containers detected.") {
      ...
      if (medicals != "") {
        let med_prompt =
          "The following text is the label of a medicinal bottle or product. Briefly answer the following questions:\n 1. What is this medication and what is it used for?\n 2. What should someone taking this medication be aware of?\n 3. How often should this person take this medication? 4. How may this medication affect the user based on medical notes?";
        med_prompt =
          "The following is user information regarding prescription and doctor notes respectively:\n" +
        ...
        console.log(await default_info);
      }
    }
